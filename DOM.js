...
var DOM = 
{
    ...
    "createElementByTag": function(tag, id = null, className = null, parent = null)
    {
    ...
    "createElementToExistingElement" : function(tag, id, className, parent = null)
    {
        ...
        var newElement = this.createElementByTag(tag, id, className, parentID);
